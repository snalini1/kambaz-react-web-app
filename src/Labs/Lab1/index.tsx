...
tag to tell browsers to render the gaps.
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-chilli-paneer">
            ...
            <li>Combine, garnish, and serve!</li>
        </ol>
        ...
        Nalini's favorite books (in no particular order)
        <ul id="wd-your-books">
            <li>Sapiens</li>
      ...
      <input type="number"
       ...
       <h4>Anchor tag</h4>
       Please 
       <a href="https://github.com/snalini1/kambaz-react-web-app" id="wd-github"> click here </a>
       to go to repository<br/>
    </div>
);}
